...
namespace PixelWorldsServer2.DataManagement
{
    class MsgLabels
    {
        ...
        public struct PlayerData // pD
        {
            ...
            public const string tutorialState = "tutorialState";
            ...
            public const string xpLvl = "xpLvl";
            public const string nameChangeCounter = "nameChangeCounter";
            public const string Spots = "spots"; // player set
      ...
      //      public const string fishSend = "TrTFFMP";
