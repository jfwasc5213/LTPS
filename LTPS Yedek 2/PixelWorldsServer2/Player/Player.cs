...
namespace PixelWorldsServer2
{
    public class Player
    {
        ...
        public Player(SQLiteDataReader reader)
        {
            ...
            this.inventoryManager.InitInventoryFromBinary(invData);
        }
        ...
        {
            Data.XP += amt;
            BSONObject bObj = new BSONObject("XP")
            {
                ["Amt"] = amt
            };
        ...
        public void Save()
        {
            ...
            cmd.Parameters.AddWithValue("@level", Data.lvl);
