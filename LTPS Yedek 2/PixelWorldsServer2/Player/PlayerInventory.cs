...
namespace PixelWorldsServer2
{
    ...
    public class PlayerInventoryManager
    {
        ...
        {
            // bunch of cool items
            this.AddItemToInventory((WorldInterface.BlockType)1, InventoryItemType.Block, 250);
            this.AddItemToInventory((WorldInterface.BlockType)16, InventoryItemType.Block, 250);
            this.AddItemToInventory((WorldInterface.BlockType)1421, InventoryItemType.Block, 100);
            this.AddItemToInventory((WorldInterface.BlockType)1605, InventoryItemType.Block, 10);
            this.AddItemToInventory((WorldInterface.BlockType)413, InventoryItemType.Block, 1);
            this.AddItemToInventory((WorldInterface.BlockType)3482, InventoryItemType.WearableItem, 1);
            this.AddItemToInventory((WorldInterface.BlockType)784, InventoryItemType.WearableItem, 1);
            this.AddItemToInventory((WorldInterface.BlockType)1085, InventoryItemType.WearableItem, 1);
            this.AddItemToInventory((WorldInterface.BlockType)592, InventoryItemType.WearableItem, 1);
            this.AddItemToInventory((WorldInterface.BlockType)2334, InventoryItemType.WearableItem, 1);
            this.AddItemToInventory((WorldInterface.BlockType)2335, InventoryItemType.WearableItem, 1);
            this.AddItemToInventory((WorldInterface.BlockType)662, InventoryItemType.WearableItem, 1);
        }
